    ...
    def build_types_embedding(
        ...
        if init_type_embedding_from_bert:
            ...
            tokenizer = BertTokenizer.from_pretrained(
                "bert-base-uncased", do_lower_case=do_lower_case, cache_dir=cache_to, mirror='https://mirrors.tuna.tsinghua.edu.cn/hugging-face-models',
            )
            model = BertModel.from_pretrained("bert-base-uncased", cache_dir=cache_mo, output_hidden_states=True, mirror='https://mirrors.tuna.tsinghua.edu.cn/hugging-face-models').to(device)
            p_length = len(prompt_list)
            embeddings_sum = []
            for i in range(p_length):
                senten = prompt_list[i]
...
class Corpus(object):
    def __init__(
        ...
        self.tokenizer = BertTokenizer.from_pretrained(
            bert_model, do_lower_case=do_lower_case, mirror='https://mirrors.tuna.tsinghua.edu.cn/hugging-face-models'
        )
